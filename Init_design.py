...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(702, 321)
        MainWindow.setFixedSize(702, 321)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/RecordItem.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/bluetooth.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.blueToothBtn.setIcon(icon1)
        self.blueToothBtn.setIconSize(QtCore.QSize(25, 25))
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icons/Dataview.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.databaseConnBtn.setIcon(icon2)
        self.databaseConnBtn.setIconSize(QtCore.QSize(25, 25))
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icons/Writeitem.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.writeBtn.setIcon(icon3)
        self.writeBtn.setIconSize(QtCore.QSize(25, 25))
        ...
        self.gridLayoutWidget_3.setGeometry(QtCore.QRect(-10, -10, 101, 41))
        ...
        self.searchBtn.setMinimumSize(QtCore.QSize(30, 20))
        ...
        self.infoTable.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
